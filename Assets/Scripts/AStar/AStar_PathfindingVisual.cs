...
public class AStar_PathfindingVisual : MonoBehaviour {
    ...
    public void SetGrid(Grid<AStar_PathNode> grid) {
        this.grid = grid;
        UpdateVisual();
    ...
    private void Grid_OnGridValueChanged(object sender, Grid<AStar_PathNode>.OnGridObjectChangedEventArgs e) {
        updateMesh = true;
    }
